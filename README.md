...
1. Go to `facebook.com`, log in, and navigate to the page you want to check.
...
5. Matching posts and totals (reactions/comments/shares) appear in the
...
- `content.js` — reads the Facebook page DOM and extracts matching posts + metrics
